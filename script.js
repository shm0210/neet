...
function optimizeForMobile() {
    // Simplify countdown display on very small screens
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeProgressTracking();
    initializeTheme();
    initializeResponsiveFeatures(); // Add this line
...
// Enhanced error handling for different screen sizes
function handleDataError(error, fallbackMessage) {
    console.error(error);
    
    // Show appropriate error message based on screen size
    const screenWidth = window.innerWidth;
    let userMessage = fallbackMessage;
    
    if (screenWidth < 768) {
        userMessage = "Error loading content. Please check your connection.";
    }
